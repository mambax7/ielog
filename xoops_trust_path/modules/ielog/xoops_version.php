...
// Menu
global $xoopsDB , $xoopsUser , $ielog_catonsubmenu ,$ielog_usevote, $table_cat ,$ielog_usegooglemap,$ielog_indexpage ;
$modversion['hasMain'] = 1 ;
$subcount = 1 ;
include dirname( __FILE__ ) . '/include/get_perms.php' ;
if( isset( $ielog_usegooglemap ) && $ielog_usegooglemap ) {
	if( isset( $ielog_indexpage ) && $ielog_indexpage == 'map' ) {
...
if( isset( $ielog_catonsubmenu ) && $ielog_catonsubmenu ) {
...
if( $global_perms & 256 ) {	// GNAV_GPERM_RATEVIEW
	if( isset( $ielog_usevote ) && $ielog_usevote ) {
...
$modversion['blocks'][1] = array(
	...
	'show_func'		=> 'b_ielog_ritem_show' ,
	'edit_func'		=> 'b_ielog_ritem_edit' ,
...
$modversion['blocks'][2] = array(
	...
	'show_func'		=> 'b_ielog_topnews_show' ,
	'edit_func'		=> 'b_ielog_topnews_edit' ,
	'options'		=> "$mydirname|5|20|0|1||1|0|1|0" ,
	'template'		=> '' ,
	'can_clone'		=> true ,
) ;
...
$modversion['blocks'][3] = array(
	...
	'show_func'		=> 'b_ielog_tophits_show' ,
	'edit_func'		=> 'b_ielog_tophits_edit' ,
	'options'		=> "$mydirname|5|20|0|1||1|0|1|0" ,
	'template'		=> '' ,
	'can_clone'		=> true ,
) ;
...
$modversion['blocks'][6] = array(
	...
	'show_func'		=> 'b_ielog_menu_show' ,
	'edit_func'		=> 'b_ielog_menu_edit' ,
	'options'		=> "$mydirname|1" ,
	'template'		=> '' ,
	'can_clone'		=> true ,
) ;
...
$modversion['blocks'][7] = array(
	...
	'show_func'		=> 'b_ielog_archive_show' ,
	'edit_func'		=> '' ,
	'options'		=> "$mydirname" ,
	'template'		=> '' ,
	'can_clone'		=> true ,

...
if( defined( 'FOR_XOOPS_LANG_CHECKER' ) ) $mydirname = 'ielog' ;
...
define( $constpref.'_DESC_INCLUDE_KML','specify KML file (.kml,.kmz) that can be displayed with GoogleEarth. Please input it with one URL a line that starts from "http://". <br />Example¡Ë<br />http://xoops.iko-ze.net/modules/ielog/kml.php');

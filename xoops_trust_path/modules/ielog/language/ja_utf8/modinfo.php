...
define( $constpref.'_DESC_INCLUDE_KML','GoogleEarthで表示可能なKMLファイル(.kml,.kmz)を指定できます。この情報は常に表示されます。<br />１行につき１件ずつ、"http://"から始まるURLで入力してください。<br />入力例）<br />http://xoops.iko-ze.net/modules/ielog/kml.php');

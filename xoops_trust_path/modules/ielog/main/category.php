...
$view = empty( $_GET['view'] ) ? $ielog_viewcattype : $_GET['view'] ;
$num = empty( $_GET['num'] ) ? intval( $ielog_newphotos ) : intval( $_GET['num'] ) ;
$num = $num < 1 ?  10 : $num ;
...
if( $view == 'table' ) {
	...
	$function_assigning = 'ielog_get_array_for_photo_assign' ;
...
if( $cid > 0 ) {
	...
	if( $ielog_body_editor == 'common_fckeditor' || 
		($ielog_body_editor == 'common_spaw' && file_exists( XOOPS_ROOT_PATH.'/common/spaw/spaw_control.class.php' )) ||
		$ielog_body_editor == 'pure_html'){
		$arrow_html=1;
		$arrow_br=0;
	} else {
		$arrow_html=0;
	...
	$xoopsTpl->assign( 'subcategories' , ielog_get_sub_categories( $cid , $cattree ) ) ;
	$xoopsTpl->assign( 'category_options' , ielog_get_cat_options() ) ;
	...
	//counts
	$photo_num_total = ielog_get_photo_total_sum_from_cats( $cids , "status>0" ) ;
	...
	if($ielog_indexpage=='map'){
		$xoops_breadcrumbs[] = array( 'url' => XOOPS_URL.'/modules/'.$mydirname.'/index.php?page=category' , 'name' => _MD_GNAV_CAT_ITEMLIST ) ;
	}
	$xoops_breadcrumbs = ielog_add_breadcrumbs( $pid , "index.php".( $page_cat ? '?'.$page_cat:''),$xoops_breadcrumbs);
	...
	if( $uid < 0 ) {
		...
		$pagetitle = sprintf( _MD_GNAV_CAT_MOREPHOTOS,ielog_get_name_from_uid( $uid )) ;
	}
	...
	$get_append = "m=$month" ;
	$pagetitle = date("YÇ¯m·î",$gettime)."¤ÎÅê¹Æ" ;
	...
	$xoopsTpl->assign( 'subcategories' , ielog_get_sub_categories( 0 , $cattree ) ) ;
	$xoopsTpl->assign( 'category_options' , ielog_get_cat_options() ) ;
...
$get_append = $view == $ielog_viewcattype ? $get_append : ( $get_append ? $get_append.'&' : '' )."view=".$view ;
...
if( $photo_small_sum > 0 ) {
	...
	$prs = $xoopsDB->query( "SELECT l.lid, l.cid,l.cid1,l.cid2,l.cid3,l.cid4, l.title, l.poster_name,l.icd, l.ext, l.res_x, l.res_y, l.ext1, l.res_x1, l.res_y1,l.ext2, l.res_x2, l.res_y2, l.ext3, l.res_x3, l.res_y3, l.ext4, l.res_x4, l.res_y4, l.ext5, l.res_x5, l.res_y5, l.ext6, l.res_x6, l.res_y6, l.ext7, l.res_x7, l.res_y7, l.ext8, l.res_x8, l.res_y8, l.status, l.date, l.hits, l.rating, l.votes, l.comments,l.caption,l.caption1,l.caption2,l.caption3,l.caption4,l.caption5,l.caption6,l.caption7,l.caption8, l.submitter,l.url,l.tel,l.fax,l.zip,l.other1,l.other2,l.other3,l.other4,l.other5,l.other6,l.other7,l.other8,l.other9,l.other10,l.other11,l.other12,l.other13,l.other14,l.other15,l.other16,l.other17,l.other18,l.other19,l.other20,l.address,l.rss,l.lat,l.lng,l.zoom,l.mtype,  t.description,t.arrowhtml,t.addinfo FROM $table_photos l USE INDEX (date) INNER JOIN $table_text t ON l.lid=t.lid WHERE $where AND l.status>0 ORDER BY {$ielog_orders[$orderby][0]}" , $num , $pos ) ;
	if( ! $prs ) {
		$prs = $xoopsDB->query( "SELECT l.lid, l.cid,l.cid1,l.cid2,l.cid3,l.cid4, l.title, l.poster_name,l.icd, l.ext, l.res_x, l.res_y, l.ext1, l.res_x1, l.res_y1,l.ext2, l.res_x2, l.res_y2, l.ext3, l.res_x3, l.res_y3, l.ext4, l.res_x4, l.res_y4, l.ext5, l.res_x5, l.res_y5, l.ext6, l.res_x6, l.res_y6, l.ext7, l.res_x7, l.res_y7, l.ext8, l.res_x8, l.res_y8, l.status, l.date, l.hits, l.rating, l.votes, l.comments,l.caption,l.caption1,l.caption2,l.caption3,l.caption4,l.caption5,l.caption6,l.caption7,l.caption8, l.submitter,l.url,l.tel,l.fax,l.zip,l.other1,l.other2,l.other3,l.other4,l.other5,l.other6,l.other7,l.other8,l.other9,l.other10,l.other11,l.other12,l.other13,l.other14,l.other15,l.other16,l.other17,l.other18,l.other19,l.other20,l.address,l.rss,l.lat,l.lng,l.zoom,l.mtype,  t.description,t.arrowhtml,t.addinfo FROM $table_photos l INNER JOIN $table_text t ON l.lid=t.lid WHERE $where AND l.status>0 ORDER BY {$ielog_orders[$orderby][0]}" , $num , $pos ) ;
	}
	...
	if( $photo_small_sum > 1 ) {
		...
		$xoopsTpl->assign( 'lang_cursortedby' , sprintf( _MD_GNAV_ODR_CURSORTEDBY , $ielog_orders[$orderby][1] ) ) ;
...
// comments
if($IELOG_MOBILE){
	ielog_mobile_templete_disp("db:{$mydirname}_mobile_viewcat.html");
}else{

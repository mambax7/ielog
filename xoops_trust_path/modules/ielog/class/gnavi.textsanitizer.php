...
if( ! class_exists( 'IElogTextSanitizer' ) ) {

include_once( XOOPS_ROOT_PATH . '/class/module.textsanitizer.php' ) ;

class IElogTextSanitizer extends MyTextSanitizer {
	...
	*/
	...
	function &getInstance()
	{
		static $instance;
		if (!isset($instance)) {
			$instance = new IElogTextSanitizer();
		}
		return $instance;
	}
...
/*		if ($html != 1) {
	...
	*/
	function stripSlashesGPC($text)
	{
		...
		if( function_exists( 'ielog_callback_after_stripslashes_local' ) ) {
			$text = ielog_callback_after_stripslashes_local( $text ) ;
		}

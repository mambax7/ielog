...
if( ! empty( $_POST['action'] ) && $_POST['action'] == 'admit' && isset( $_POST['ids'] ) && is_array( $_POST['ids'] ) ) {
	...
	redirect_header( 'index.php?page=admission' , 2 , _MD_A_IELOG_ADMITTING ) ;
	exit ;
...
echo "<h3 style='text-align:left;'>".sprintf(_MD_A_IELOG_FMT_ADMISSION,$xoopsModule->name())."</h3>\n" ;
...
<table width='95%' class='outer' cellpadding='4' cellspacing='1'>
  <tr valign='middle'>
    ...
    <th></th>
    <th>"._MD_A_IELOG_TH_SUBMITTER."</th>
    <th>"._MD_A_IELOG_TH_TITLE."</th>
    <th>"._MD_A_IELOG_TH_DESCRIPTION."</th>
    <th>"._MD_A_IELOG_TH_CATEGORIES."</th>
  </tr>
" ;
...
echo "
  <tr>
    <!-- <td colspan='4' align='left'>"._MD_A_IELOG_LABEL_ADMIT."<input type='submit' name='admit' value='"._MD_A_IELOG_BUTTON_ADMIT."' /></td> -->
    <td colspan='8' align='left'>"._MD_A_IELOG_LABEL_ADMIT."<input type='button' value='"._MD_A_IELOG_BUTTON_ADMIT."' onclick='document.MainForm.action.value=\"admit\"; submit();' /></td>
  </tr>
  <tr>
    <td colspan='8' align='left'>"._MD_A_IELOG_LABEL_REMOVE."<input type='button' value='"._MD_A_IELOG_BUTTON_REMOVE."' onclick='if(confirm(\""._MD_A_IELOG_JS_REMOVECONFIRM."\")){document.MainForm.action.value=\"delete\"; submit();}' /></td>
  </tr>
</table>
</form>
</td></tr></table>

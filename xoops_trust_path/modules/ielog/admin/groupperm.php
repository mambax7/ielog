...
function list_groups()
{
	...
	$form = new MyXoopsGroupPermForm( '' , $xoopsModule->mid() , 'ielog_global' , _MD_A_IELOG_GROUPPERM_GLOBALDESC ) ;
...
if( ! empty( $_POST['submit'] ) ) {
	...
	redirect_header("index.php?page=groupperm" , 1 , _MD_A_IELOG_GPERMUPDATED );
}
...
echo "<h4 style='text-align:left;'>"._MD_A_IELOG_GROUPPERM_GLOBAL."</h4>\n" ;
list_groups() ;
xoops_cp_footer() ;

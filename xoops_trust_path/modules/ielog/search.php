...
{
	return ielog_global_search_base( "'.$mydirname.'" , $keywords , $andor , $limit , $offset , $userid ) ;
}

' ) ;


if( ! function_exists( 'ielog_global_search_base' ) ) {

function ielog_global_search_base( $mydirname , $keywords , $andor , $limit , $offset , $userid )
{

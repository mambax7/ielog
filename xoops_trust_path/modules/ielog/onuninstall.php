...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return ielog_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'ielog_onuninstall_base' ) ) {

function ielog_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'ielog_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function ielog_message_append_onuninstall( &$module_obj , &$log )
{

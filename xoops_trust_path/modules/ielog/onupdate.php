...
eval( ' function xoops_module_update_'.$mydirname.'( $module ) { return ielog_onupdate_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'ielog_onupdate_base' ) ) {

function ielog_onupdate_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUpdate.' . ucfirst($mydirname) . '.Success', 'ielog_message_append_onupdate' ) ;
		$msgs = array() ;
	} else {
...
function ielog_message_append_onupdate( &$module_obj , &$log )
{

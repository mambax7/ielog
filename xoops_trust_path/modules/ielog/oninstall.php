...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return ielog_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'ielog_oninstall_base' ) ) {

function ielog_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'ielog_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function ielog_message_append_oninstall( &$module_obj , &$log )
{
